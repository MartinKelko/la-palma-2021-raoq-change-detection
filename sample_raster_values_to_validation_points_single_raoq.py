...
# path to your RaoQ classic binary map folder
folders = [
    r"path\to\your\RaoQ\classic\binary\map\folder",
]

# path to your RaoQ classic binary map output folder
final_out = (
    r"path\to\your\RaoQ\classic\binary\map\output\folder"
)
